                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="icon-box">
                                        <div class="icon"><span class="flaticon-mail"></span></div>
                                        <div>
                                            <div class="text"><strong>Mon - Friday</strong>9.00 am to 6.00pm</div>
                                            <div class="text"><strong>Saturday</strong>9.00 am to 4.00pm</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="widget instagram-widget">
                                    ...
                                    <div class="wrapper-box">
                                        <div class="image">
                                            <img src="assets/images/gallery/gall1.jpg" alt="">
                                            <div class="overlay-link"><a href="assets/images/gallery/gall1.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                        </div>
                                        <!--<div class="image">
                                        ...
                                        <div class="image">
                                            ...
                                            <div class="overlay-link"><a href="assets/images/gallery/gall3.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                        </div>
                                        <div class="image">
                                            <img src="assets/images/gallery/gallery-4.jpg" alt="">
                                            <div class="overlay-link"><a href="assets/images/gallery/gall4.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                        </div>
                                        <div class="image">
                                            <img src="assets/images/gallery/gall5.jpg" alt="">
    ...
    <div class="footer-bottom">
        <div class="auto-container">
            <div class="row m-0 align-items-center justify-content-between">
                <div class="copyright-text">Copyright © 2024 <?php echo $setting['site_name']; ?> | Designed By <a target="blank" href="#"> Legacy Technologies</a></div>
                <ul class="menu">
                    <li><a href="privacy.php">Privacy Policies</a></li>
                    <li><a href="terms.php">Terms & Conditions </a></li>
