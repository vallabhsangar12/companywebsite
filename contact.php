                ...
                <div class="tab-pane fadeInUp animated active" id="tab-two" role="tabpanel" aria-labelledby="tab-two">
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="icon-box">
                                            <div class="icon"><span class="flaticon-mail"></span></div>
                                            <div class="text-area">
                                                <div class="text"><strong>Mon - Friday</strong>09.00 am to 6.00pm</div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="link">-->
                                <a href="https://wa.me/918007029012" class="theme-btn btn-style-one"><span><i class="flaticon-up-arrow"></i>Connect with us</span></a>
                            </div>
                        </div>
                    </div>
                </div>
