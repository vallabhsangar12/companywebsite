...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- Page Title -->
        <section class="page-title" style="background-image: url(assets/images/background/faq.png);">
                        ...
                        <div class="tab-pane fadeInUp animated" id="tab-three" role="tabpanel"
                            ...
                            <ul class="accordion-box style-two mb-30">
                                ...
                                <li class="accordion block">
                                    ...
                                    <div class="acc-content">
                                        <div class="content">
                                            <div class="text">We specialize in web development, software development, digital marketing, and graphic design. <br> Our services include website design and development, custom software solutions, SEO, social media marketing, and branding.
                                            </div>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="tab-pane fadeInUp animated" id="tab-four" role="tabpanel"
                            ...
                            <ul class="accordion-box style-two mb-30">
                                ...
                                <li class="accordion block">
                                    ...
                                    <div class="acc-content">
                                        <div class="content">
                                            <div class="text">We specialize in web development, software development, digital marketing, and graphic design. Our services include website design and development, custom software solutions, SEO, social media marketing, and branding.
                                            </div>
                                        </div>
                                    </div>
                                </li>
