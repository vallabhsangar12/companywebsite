...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- Page Title -->
        <section class="page-title" style="background-image: url(assets/images/background/service1.png);">
        ...
        <section class="services-section style-two ">
            <div class="auto-container">
                <div class="sec-title text-center">
                    ...
                    <h2>Your Business, Our Expertise <br> Transform Your Business Digitally</h2>
                </div>
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p><b>We are your partners in digital transformation. From crafting intuitive websites and robust applications to optimizing your digital marketing strategy, we offer a comprehensive suite of services. Our expertise lies in delivering tailored solutions that align with your business objectives and drive tangible results.</b></p>
                    <p>Whether you require a dynamic e-commerce platform, a cutting-edge mobile app, or a comprehensive digital marketing strategy, we have the skills and experience to bring your vision to life.</p>
                </div>
            </div>
        </div>
        ...
        <section class="services-section-two style-two mx-30">
            <div class="auto-container">
                <div class="sec-title text-center">
                    <div class="sub-title">Our Special Services</div>
                    <h2>We offers ERP Softwares &<br>Web Development Services</h2>
                </div>
                <div class="row">
                    <div class="col-xl-6 service-block-two">
                        <div class="inner-box">
                            <div class="image-box">
                                <img src="assets/images/resource/ERP 315x 319.png" alt="">
                                <div class="icon"><span class="flaticon-insurance"></span></div>
                            </div>
                            <div class="content">
                                <h4>ERP SOFTWARE SERVICES</h4>
                                <div class="text">Dairy Management Software: Streamline milk procurement, processing, and distribution.
Farm Management Software: Manage livestock, crops, finances, and equipment.
       <Br><br>Inventory Management Software: Track inventory levels, manage stock, and optimize purchasing. <br><br> Financial Management Software: Handle accounting, budgeting, and financial reporting.<br><br> Software for Hotels and Restaurants with K.O.T. Management, Table Booking, Room Rent Service, Billing, Stock Management, Production.<br><br>Software for Institutes to handle Enquiry, Admission, Fee Management, Library, Attendance, Time Table.<br><br>ERP Software for Schools & Colleges to handle Enquiry, Admission, Fee Management, Library, Attendance, Time Table, Certificates, ID Card, Reminder Letters, Demand Register.<br><br>E.R.P. Software For Hospitals with IPD, OPD, Billing, Accounting, Medicine Stock, Inventory Stock,Advance Payment & Balance Facility.<br><br>E.R.P. Software For Library with Books Record, Issue, Receipt, Sticker Printing, Library Card, Pending Books List,Book Ledger & User Security<br>
                                    </div>
                                <!--<div class="link">
                    ...
                    <div class="col-xl-6 service-block-two">
                        <div class="inner-box">
                            <div class="image-box">
                                <img src="assets/images/resource/web 315x319.png" alt="">
                                <div class="icon"><span class="flaticon-import"></span></div>
                            </div>
                            <div class="content">
                                <h4>WEB DEVELOPMENT SERVICES</h4>
                                <div class="text">E-commerce Websites: Build robust online stores to showcase and sell your products effectively.<br>
Portfolio Websites: Create stunning digital portfolios to showcase your work and attract clients.<br><br>
Business Websites: Develop professional websites that effectively communicate your brand and engage your audience.<br><br>
Inventory Management Websites: Efficiently manage your stock levels, track product movement, and optimize inventory.<br><br>
Web Applications: Build custom web-based applications to streamline business processes and improve efficiency.<br><br>
Responsive Design: Ensure your website looks and functions flawlessly across all devices.<br><br>
Search Engine Optimization (SEO): Optimize your website for better search engine visibility.<br><br>
Content Management Systems (CMS): Develop user-friendly CMS platforms for easy website management.<br>
Web Hosting and Maintenance: Provide reliable hosting and ongoing website support.<br><br></div>
                                <!--<div class="link">
                                <a href="#" class="readmore-link"><span><i class="flaticon-up-arrow"></i>Read More</span></a>
                            </div>-->
                            </div>
